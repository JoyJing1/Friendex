...
User.create!(email: "test", password: "testtest")
User.create!(email: "test2", password: "testtest")
User.create!(email: "test3", password: "testtest")
User.create!(email: "test4", password: "testtest")
User.create!(email: "test5", password: "testtest")
User.create!(email: "test6", password: "testtest")
User.create!(email: "test7", password: "testtest")
User.create!(email: "test8", password: "testtest")
