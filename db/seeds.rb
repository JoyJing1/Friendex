...
Profile.create!(user_id: 2,
    ...
    gender: "female",
    relationship: "married",
    profile_img: "http://res.cloudinary.com/joyjing1/image/upload/v1467198451/profiles/sheryl-sandberg-hed-2014.jpg",
...
Profile.create!(user_id: 3,
    ...
    gender: "male",
    relationship: "married",
    profile_img: "http://res.cloudinary.com/joyjing1/image/upload/v1467945109/profiles/Marc-Andreessen.jpg",
...
Profile.create!(user_id: 4,
    ...
    gender: "male",
    relationship: "married",
    profile_img: "http://res.cloudinary.com/joyjing1/image/upload/v1467944804/profiles/9hpv14pc.jpg",
...
Profile.create!(user_id: 7,
    ...
    gender: "male",
    relationship: "single",
    profile_img: "http://res.cloudinary.com/joyjing1/image/upload/v1467944951/profiles/0303_whatsapp-jan-koum-1_1024x576.jpg",
...
Profile.create!(user_id: 8,
    ...
    gender: "male",
    relationship: "married",
    profile_img: "http://res.cloudinary.com/joyjing1/image/upload/v1467944873/profiles/linkedin-ceo-jeff-weiner-explains-his-no-1-management-principle.jpg",
