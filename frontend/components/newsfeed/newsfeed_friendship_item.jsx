          ...
          <div className="post-friends-info">
            ...
            <div className="user-profile-img-container">
              <Link to={`/users/${this.props.friendship.friend_id}`}>
                <img src={this.props.friendship.friend_img.replace('upload','upload/c_scale,w_150')} alt='friend'></img>
              </Link>
            </div>
            ...
            <div className="user-profile-img-container">
              <Link to={`/users/${this.props.friendship.new_friend_id}`}>
                <img src={this.props.friendship.new_friend_img.replace('upload', 'upload/c_scale,w_150')} alt="new-friend"></img>
              </Link>
            </div>
