  ...
  _currentlyFriendsButton() {
    return(
      <button className="add-friend currently-friends"
        ...
        <img src="http://res.cloudinary.com/joyjing1/image/upload/c_limit,h_10,w_10/v1467497415/iconmonstr-check-mark-1-240_uufxhe.png">
        </img>
        Friends
      </button>
    );
  ...
  _addFriendButton() {
    return(
      <button className="add-friend"
        ...
        <img src="https://res.cloudinary.com/joyjing1/image/upload/c_limit,h_10,w_10/v1467342419/icons/iconmonstr-user-8-240.png">
        </img>
        Add Friend
      </button>
    );
  ...
  _cancelFriendRequestButton() {
    return(
      <button className="add-friend cancel-request"
        ...
        <img src="http://res.cloudinary.com/joyjing1/image/upload/c_limit,h_10,w_10/v1467495849/iconmonstr-user-11-240_1_ehz8lh.png">
        </img>
        Cancel Request
      </button>
    );
